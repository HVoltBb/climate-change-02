...
### Source code
The source files contain four R scripts [the main program](src/CV.r), [data preprocessor](src/prep.r), [warm-up run on your local machine](src/wu.r), [jobs that can be dispatched on your local machine or offloaded to a cluster](src/job.r), two header files [1](src/growth.h) and [2](src/growth_imp.h), and a [TMB script](src/v5_3.cpp).
